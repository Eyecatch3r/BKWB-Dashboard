...
export default function Home() {
    return (
        <main className="flex min-h-screen flex-col items-center p-4 sm:p-8 md:p-12 lg:p-16 dark:bg-gray-800">
            <div className="flex flex-wrap flex-col sm:flex-row justify-evenly p-2 sm:p-0">
                <a
